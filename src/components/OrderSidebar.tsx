...
export default function OrderSidebar({ layout = "sidebar" }: OrderSidebarProps) {
  return (
    ...
    >
      ...
      <h1 id="order-sidebar-heading" className="order-sidebar__title">
        Get Your <span className="order-sidebar__title-accent">Dummy Ticket</span> in Minutes
      </h1>

      <div className="order-sidebar__book-image">
        <Image
          src="/bookdummyimg.png"
          alt="Sample dummy flight ticket booking preview"
          width={520}
          height={640}
          priority
          className="order-sidebar__book-image-img"
        />
      </div>

      <a
        href={CTA_CONTACT.whatsappUrl}
        className="order-sidebar__whatsapp"
        target="_blank"
        rel="noopener noreferrer"
      >
        <span className="order-sidebar__whatsapp-icon">
          <WhatsAppIcon />
        </span>
